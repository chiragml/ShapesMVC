...
public class rectangleTest {
  ...
  public void testXPosNull() {
    s1 = new rectangle(null,55.6,56.0,45.0,col1,"Rect 1");
  }
  ...
  public void testYPosNull() {
    s1 = new rectangle(546.0,null,56.0,45.0,col1,"Rect 1");
  }
  ...
  public void testWidthNull() {
    s1 = new rectangle(48.5,55.6,null,45.0,col1,"Rect 1");
  }
  ...
  public void testHeightNull() {
    s1 = new rectangle(65.5,55.6,56.0,null,col1,"Rect 1");
  }
  ...
  public void testColorNull() {
    s1 = new rectangle(89.5,55.6,56.0,45.0,null,"Rect 1");
  }
  ...
  public void testNameNull() {
    s1 = new rectangle(78.9,55.6,56.0,45.0,col1,null);
  }
  ...
  public void testNegativeWidth() {
    s1 = new rectangle(5646.5,55.6,-56.0,45.0,col1,"Rect 1");
  }
  ...
  public void testEmptyName() {
    s1 = new rectangle(5646.5,55.6,-56.0,45.0,col1,"");
  }
...
//  s1 = new rectangle(25.2, 55.6, 56.0, 45.0, col1, "Rect 1");
  ...
  @Test
  public void getName() {
    assertEquals("Rect 1", s1.getName());
    assertEquals("Rect 2", s2.getName());
    assertEquals("Rect 3", s3.getName());
